...
insert into student values(3,'ammu','kannur',100,100,98,298);
insert into student values(4,'anu','kizhakkayil',100,100,80,280);
insert into student values(5,'manu','alappuzha',100,100,100,300);
insert into student values(6,'raju','kottayam',100,51,100,251);
insert into student values(7,'fathima','kochi',100,100,21,221);
insert into student values(8,'ayisha','flower',100,50,100,250);
insert into student values(9,'shuhana','kondotty',100,1,100,201);
insert into student values(10,'sufail','palakad',10,100,10,120);
select * from student;
